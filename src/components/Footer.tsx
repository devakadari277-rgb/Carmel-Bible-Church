    ...
    <footer className="bg-church-blue text-slate-300 border-t border-church-gold/20 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img
                ...
                className="h-10 w-10 object-contain rounded-full border border-church-gold/30"
              />
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold text-white font-display mb-4">Quick Direct Links</h4>
